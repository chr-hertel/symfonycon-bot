...
class AppFixtures extends Fixture
{
    ...
    private function loadDayOne(): array
    {
        return [
            ...
            new Slot('What happens when you press enter in the browser?', new \DateTimeImmutable('11/21/19 14:20'), new \DateTimeImmutable('11/21/19 15:00'), 'Tobias Sjösten', 'PHP'),
